    ...
    if r2:
        ...
        if df.empty == False:
            ...
            if (('Average active power A (kW)' in df.columns) and ('Average active power B (kW)' in df.columns) and (
                ...
                df['total'] = df['Average active power A (kW)'] + df['Average active power B (kW)'] + df[
                    'Average active power C (kW)']
            ...
            if (('Reactive Power A (kVAR)' in df.columns) and ('Reactive Power B (kVAR)' in df.columns) and (
                ...
                df['total'] = df['Reactive Power A (kVAR)'] + df['Reactive Power B (kVAR)'] + df[
