...
def plot_energy_and_temperature(df):
    ...
    plt.title('Daily energy consumption & mean daily temperature', fontsize=16)
    fig.tight_layout()
...
class FPDF(FPDF):
  ...
  #      self.image('picturemessage_vinnf3lu.tl2.png', x=180, y=None, w=25, h=8)
    def header(self):
        self.set_y(10)
        self.image('picturemessage_vinnf3lu.tl2.png', x=10, y=None, w=30, h=10)
...
def create_pdf(filename, max_power, total_energy, month_Name, building_name):
    ...
    pdf.cell(0,10, "(Bowling Green)", 0, 1, 'C')
    str9 = " "
    pdf.write(5, str9)
    #pdf.image(building_name, x=10, y=None, w=180, h=120, type='', link='')
    pdf.image("epri_photos/Bowling_Green.png", x=10, y=None, w=180, h=120, type='', link='')
    pdf.cell(0, 10, "\n", 0, 1, 'C')
    pdf.write(5, str9)
    pdf.set_xy(10, 160)
